...
export function HyperliquidIcon({ className, ...props }: SVGProps<SVGSVGElement>) {
  return (
    <svg viewBox="0 0 144 144" fill="none" xmlns="http://www.w3.org/2000/svg" className={className} {...props}>
      <path
        className="fill-[#072723] dark:fill-[#97FCE4]"
